...
(function() {
  ...
  Bacon.fromBinder = function(binder, eventTransformer) {
    ...
    return new EventStream(function(sink) {
      ...
      return unbinder = binder(function() {
        var args, e, event, reply, value, _i, _len, _results;
  ...
  Bacon.combineAsArray = function() {
    ...
    if (streams.length) {
      ...
      return new Property(function(sink) {
        var combiningSink, ends, i, initialSent, sinkFor, _;
        ...
        return new CompositeSubscriber(((function() {
          var _i, _len, _results;

          _results = [];
          for (i = _i = 0, _len = streams.length; _i < _len; i = ++_i) {
            _ = streams[i];
            _results.push(sinkFor(i));
          }
          return _results;
        })()).unsubscribe);
      });
  ...
  Next = (function(_super) {
    ...
    Next.prototype.toNext = function() {
      return this;
    };
  ...
  Observable = (function() {
    ...
    Observable.prototype.flatMap = function(f) {
      ...
      return new EventStream(function(sink) {
        ...
        composite = new CompositeSubscriber();
        checkEnd = function() {
          if (composite.subscriptions.length === 0) {
            return sink(end());
          }
        };
        composite.add(function() {
          return root.subscribe(function(event) {
            ...
            if (event.isEnd()) {
              ...
              child = f(event.value());
              return composite.add(function(unsubAll) {
                return child.subscribe(function(event) {
                  var reply;

                  if (event.isEnd()) {
                    return composite.remove(this);
                  } else {
                    reply = sink(event.toNext());
                    if (reply === Bacon.noMore) {
                      unsubAll();
                    }
                    return reply;
  ...
  Dispatcher = (function() {
    function Dispatcher(subscribe, handleEvent) {
      ...
      this.push = function(event) {
        var e, reply, sink, tmpSinks, _i, _len;
  ...
  Bacon.When = function() {
    var i, index, len, pat, pats, patterns, s, sources, _i, _len, _ref3;
    ...
    return new EventStream(function(sink) {
      ...
      match = function(p) {
        return _.all(p.ixs, function(i) {
          return sources[i].queue.length > 0;
        });
      };
      cannotMatch = function(p) {
        return _.any(p.ixs, function(i) {
          return sources[i].queue.length === 0 && sources[i].isEnded;
        });
      };
      part = function(j, source) {
        return function(unsubAll) {
          return source.obs.subscribe(function(e) {
            var p, reply, val, _j, _len1;
            ...
            if (e.isEnd()) {
              ...
              for (_j = 0, _len1 = pats.length; _j < _len1; _j++) {
                p = pats[_j];
                if (match(p)) {
                  val = p.f.apply(p, (function() {
                    ...
                    for (_k = 0, _len2 = _ref4.length; _k < _len2; _k++) {
                      i = _ref4[_k];
                      _results.push(sources[i].queue.shift());
                    }
                    return _results;
                  })());
                  reply = sink(next(val));
            ...
            if (reply === Bacon.noMore || _.all(pats, cannotMatch)) {
              sink(end());
              unsubAll();
              reply = Bacon.noMore;
            }
  ...
  CompositeSubscriber = (function() {
    function CompositeSubscriber(ss) {
      var s, _i, _len;
    ...
    CompositeSubscriber.prototype.add = function(subscription) {
      var unsub;

      if (this.unsubscribed) {
        return;
      }
      unsub = subscription(this.unsubscribe);
      if (this.subscriptions !== null) {
        return this.subscriptions.push;
      }
    };

    CompositeSubscriber.prototype.remove = function(subscription) {
      return this.subscriptions = _.remove(subscription(this.subscriptions));
    };

    CompositeSubscriber.prototype.unsubscribe = function() {
      var s, _i, _len, _ref3;

...
(function() {
  ...
  Bacon.When = function() {
    ...
    return new EventStream(function(sink) {
      var cannotMatch, i, index, len, match, part, pat, pats, s, sources, _i, _len, _ref3;
      ...
      i = 0;
      return combineSubscriptions(_.map((function(s) {
        return part(i++, s);
      }), sources));
    });
  };

  combineSubscriptions = function(sources) {
    var s, _i, _len;
